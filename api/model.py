...
for asset_id in asset_ids:
    ...
    mlflow.set_experiment("BaselineFit")
    with mlflow.start_run(run_name=f"fit_{asset_id}"):
        ...
        mlflow.log_param("max_hp_asset", max_hp_asset)
        mlflow.log_param("max_restriction_asset", max_restriction_asset)
        mlflow.log_metric("n_points", len(hp))
        ...
        mlflow.log_metric("n_bins", len(fit_bin_centers))
